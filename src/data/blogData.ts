...
const legacyBlogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "Want continuous coverage across the whole house? See the [E-Biotic Pro HVAC system](/product/e-biotic-pro) or explore the EnviroBiotics [whole-home and room systems](https://shop.envirobiotics.com/collections/shop-systems)."
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      "Here's the difference that matters. A room purifier treats the air and surfaces within its coverage radius, 300 sq ft for a small unit, up to 800 for a large one. To cover a whole house that way, you'd need one unit per room, each with its own cartridge and its own plug. The [E-Biotic Pro](/product/e-biotic-pro) covers up to 25,000 sq ft from a single point, because it borrows the reach your furnace and air conditioner already have. Every time the system moves air, it moves probiotics with it.",
