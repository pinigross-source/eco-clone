...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "## Refill economics: what it costs to run",
      "Sticker price is only half the ownership story. The other half is refills, and this is where the whole-home math starts to make sense.",
      "The E-Biotic Pro runs on a 500ml probiotic cartridge that lasts roughly 90 days, so about four refills a year. That single cartridge is doing the work that would otherwise require refilling four, five, or six separate room-unit cartridges on their own staggered schedules.",
      "Here's the honest cost picture, laid out over three years:",
      "- **E-Biotic Pro, whole home:** roughly $2,895 installed up front, about $400 a year in refills, roughly $4,095 over three years.",
      "- **Five room units covering a large home:** roughly $2,500 to $3,500 in devices up front, about $750 a year in refills, roughly $4,750 to $5,750 over three years.",
      "A few honest takeaways:",
      "Up front, the E-Biotic Pro is not dramatically cheaper than kitting out a large home with room units. If someone tells you whole-home is the budget option, they're overselling.",
      "Over time, it pulls ahead for larger homes, fewer cartridges, one refill schedule, no gap rooms between units, and it treats the ductwork that room units never touch.",
      "For a small home, none of this applies. Running one $98 unit in a single problem room costs a fraction of a whole-home install, and you shouldn't pay for coverage you don't need.",
      "The value of the E-Biotic Pro isn't that it's the cheapest way to get probiotics into one room. It's that it's the most efficient way to get consistent coverage across an entire large home, with one system, one cartridge, and nothing to think about between refills.",
