...
const legacyBlogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    description: "Are environmental probiotics safe for your family and pets? Review the FDA GRAS status, EPA Registered status, and third-party certifications behind probiotic air purifiers.",
    ...
    content: [
      ...
      "Beyond FDA GRAS status, EnviroBiotics products are EPA Registered. The U.S. Environmental Protection Agency requires products making antimicrobial claims to submit toxicology data, product chemistry information, and efficacy studies before granting registration. EPA Registered status confirms that the products have been reviewed for safety in occupied indoor environments, including homes with children and pets.",
  ...
  },
  {
    ...
    content: [
      ...
      "Probiotic air purification systems now span multiple form factors. Portable units like the [BioLogic Mini](/product/biologic-mini) cover personal spaces up to 300 square feet. Room units like the [Biotica 800](/product/biotica-800) treat spaces up to 800 square feet. Hybrid devices like the [BA-2080](/product/ba-2080) combine HEPA filtration with probiotic dispersal. And HVAC-integrated systems like the [E-Biotic Pro](/business) deliver probiotic treatment through existing ductwork to cover up to 25,000 square feet.",
  ...
  {
    slug: "probiotic-room-spray",
    title: "What Is a Probiotic Room Spray? How Probiotic Dispensers Actually Work",
    description: "Probiotic room sprays and dispensers seed surfaces with beneficial bacteria instead of killing them. Here's how they work and how to pick one.",
    image: probioticRoomSprayImg,
    category: "blog",
    tags: ["probiotic", "room-spray", "dispenser", "bacillus", "surface-treatment", "indoor-microbiome"],
    relatedSlugs: ["purification-vs-disinfection", "indoor-microbiome-health", "are-environmental-probiotics-safe", "get-rid-of-musty-smell"],
    content: [
      ...
      "> Looking for a probiotic dispenser for a single room? See the [BioLogic Mini Gen 2](/product/biologic-mini-gen-2), covers up to 300 sq ft.",
      ...
      "If you've been Googling \"probiotic spray\" because you've read about the indoor microbiome and want to try it, the better starting point is the dispenser form, and the better thing to read next is [what indoor microbiome health actually is](/blog/indoor-microbiome-health).",
      "## Frequently Asked Questions",
      ...
      "Want one device that covers a whole home through your HVAC? Explore the EnviroBiotics [whole-home and room systems](https://shop.envirobiotics.com/collections/shop-systems)."
    ],
  },
  {
    slug: "best-air-purifier-for-allergies",
    title: "Best Air Purifier for Allergies in 2026: A Decision Guide for Every Allergen",
    description: "The best air purifier for allergies depends on which allergen you're fighting. Here's the decision matrix, HEPA, probiotic, ionizer, and what each actually does.",
    image: reduceAllergensImg,
    category: "blog",
    tags: ["allergies", "hepa", "probiotic", "dust-mites", "pet-dander", "pollen", "mold", "comparison"],
    relatedSlugs: ["probiotic-vs-hepa-air-purifier", "how-to-reduce-indoor-allergens-naturally", "why-air-purifiers-dont-solve-allergies", "best-air-purifier-for-mold"],
    content: [
      ...
      "The honest answer is: HEPA catches some of these very well, misses others almost completely, and the technology that fills the gap is something most people have never heard of. There's more on this in the [natural allergen reduction](/blog/how-to-reduce-indoor-allergens-naturally) post if you want the broader environmental approach. This post is specifically about which device to buy.",
      ...
      "This is the gap that nothing in the HEPA-only product category solves, and it's the reason a lot of allergy sufferers describe HEPA as \"helped a little\" instead of \"solved it.\" The [probiotic vs HEPA comparison](/blog/probiotic-vs-hepa-air-purifier) post goes deeper on this; the short version is that filtration alone is treating the symptom, not the source.",
      "### Ionizers",
      ...
      "There's a longer post on this, see the [best air purifier for mold](/blog/best-air-purifier-for-mold) guide.",
      ...
      "For a smaller home or a single primary problem room, the [BioLogic Mini Gen 2](/product/biologic-mini-gen-2) handles probiotic coverage for up to 300 sq ft and is quiet enough to run in a bedroom 24/7. For a larger home or multi-room coverage, the Biotica 800 covers up to 800 sq ft. For whole-house coverage, the E-Biotic Pro is HVAC-integrated.",
      ...
      "EnviroBiotics products carry FDA GRAS classification, MADE SAFE certification, and EPA Registered status. Whatever you end up buying, look for the equivalent on the HEPA side, there's a lot of marketing in this category that doesn't survive scrutiny.",
      "## The bottom line",
      ...
      "Want continuous coverage across the whole house? See the [E-Biotic Pro HVAC system](/business) or explore the EnviroBiotics [whole-home and room systems](https://shop.envirobiotics.com/collections/shop-systems)."
    ],
  },
  {
    slug: "best-air-purifier-for-asthma",
    title: "Best Air Purifier for Asthma (2026): A Buyer's Guide",
    description: "The best air purifier for asthma depends on your trigger. A trigger-by-trigger 2026 guide to HEPA, probiotic surface treatment, and what to avoid (ozone).",
    image: indoorAllergensImg,
    category: "blog",
    tags: ["asthma", "hepa", "probiotic", "dust-mites", "pet-dander", "mold", "ozone", "buying-guide"],
    relatedSlugs: ["indoor-allergens-asthma", "best-air-purifier-for-allergies", "probiotic-vs-hepa-air-purifier", "are-environmental-probiotics-safe"],
    content: [
      "**Quick answer:** The best air purifier for asthma depends on which trigger sets off your symptoms. For airborne triggers, pollen, smoke, and dander that's already aloft, a true HEPA unit sized to the room is the right tool. For settled triggers, dust mite allergen, mold, and the dander reservoir in bedding and carpet, surface treatment matters more than air filtration, and probiotic surface systems address those reservoirs directly. Avoid ozone generators and ionizers entirely: ozone is a respiratory irritant that can make asthma worse. No air purifier treats asthma. It reduces environmental triggers, which is one part of the plan your doctor sets.",
      "**A note before anything else:** an air purifier is environmental control, not medicine. It supplements, and never replaces, your prescribed medication and your doctor's asthma action plan. Nothing in this guide should be read as a claim that any device treats, prevents, or controls asthma. Talk to your physician before changing anything about how you manage your condition.",
      "## Start with your trigger, not with the product",
      "Most asthma purifier guides rank devices. That's the wrong order of operations, because two people with the same diagnosis can have completely different environmental drivers. Someone whose attacks cluster in spring is dealing with an airborne, seasonal load. Someone who wakes up wheezing every night year-round is usually dealing with a settled reservoir in the bedroom, most often dust mite allergen in the mattress and bedding.",
      "The underlying mechanism, how these particles set off an asthmatic airway, is covered in detail in our post on [how indoor allergens trigger asthma](/blog/indoor-allergens-asthma). This guide picks up where that one leaves off: given your trigger, what should you actually buy?",
      "If your concern is allergic rhinitis rather than asthma, the [best air purifier for allergies](/blog/best-air-purifier-for-allergies) guide is the better starting point. The technologies overlap; the stakes and the priorities don't.",
      "## The three technologies that matter (and the one to avoid)",
      "### True HEPA filtration",
      "A true HEPA filter traps 99.97% of particles at 0.3 microns. That covers pollen, smoke particulate, airborne mold spores, and pet dander while it's aloft. For asthma households, HEPA's value is straightforward: it lowers the concentration of airborne irritants in the room you're breathing in.",
      "Its limit is equally straightforward. A filter can only clean the air that passes through it. Anything sitting in a mattress, a rug, or a sofa cushion is invisible to it until something stirs that particle into the air.",
      "Look for: a stated CADR appropriate to your room size, sealed HEPA (not \"HEPA-type\"), a quiet low setting you can sleep next to, and no ionizer mode.",
      "### Probiotic surface treatment",
      "Probiotic systems continuously disperse beneficial **Bacillus** spores into the room, where they settle onto surfaces and consume the organic debris that allergen-producing organisms depend on. The target is the reservoir: bedding, carpet, upholstery, and damp surfaces where mold establishes.",
      "This is a different job from filtration, not a better version of it. The full comparison is in [probiotic vs HEPA](/blog/probiotic-vs-hepa-air-purifier). For asthma specifically, the relevant point is that dust mite and dander allergens spend nearly all their time on surfaces, so a device that only filters air never reaches most of the load.",
      "On safety, which is a fair question for anyone with a reactive airway: the strain safety data and third-party certifications are laid out in [are environmental probiotics safe](/blog/are-environmental-probiotics-safe). These systems produce no ozone.",
      "### Activated carbon",
      "Carbon adsorbs gases and VOCs, cooking odors, smoke, fresh paint, cleaning-product fumes. Irritant gases are a real asthma trigger for many people and particle filters do nothing about them, so a carbon stage is worth having if chemical smells set you off.",
      "### Ozone generators and ionizers: skip these",
      "This is the one firm rule in the guide. Ozone is a lung irritant. Health authorities specifically warn people with asthma away from ozone-generating air cleaners, and ionizers can produce ozone as a byproduct even when they aren't marketed as ozone devices. \"Activated oxygen,\" \"energized oxygen,\" and \"plasma\" are all names worth reading carefully before you buy.",
      "If a device doesn't state plainly that it is no-ozone, treat that as a no for an asthma household.",
      "## Recommendations by trigger",
      "### Dust mites (year-round, worse at night)",
      "Dust mite allergen is the most common driver of persistent, nocturnal asthma symptoms, and it is almost entirely a surface problem. The allergen lives in mattresses, pillows, bedding, carpet, and upholstery, and only becomes airborne for a few minutes when those things are disturbed.",
      "**Primary:** surface treatment. Wash bedding weekly in hot water, use allergen-proof encasements on the mattress and pillows, HEPA-vacuum carpet and upholstery, and hold indoor humidity at 40 to 60%. A probiotic system running continuously in the bedroom addresses the reservoir the rest of the time.",
      "**Secondary:** a HEPA unit for the disturbance windows, changing sheets, vacuuming, kids on the couch.",
      "### Pet dander (year-round, if there's an animal in the home)",
      "Dander behaves like dust mite allergen: sticky protein that settles into fabric and re-aerosolizes when disturbed.",
      "**Primary:** surface treatment across the rooms the animal uses, plus keeping pets out of the bedroom if you can manage it.",
      "**Secondary:** HEPA in the room with the most airborne exposure.",
      "### Mold and damp (year-round, worse above 60% humidity)",
      "**Primary:** source control. Fix the leak, run a dehumidifier, and have visible growth over roughly ten square feet remediated professionally. No purifier substitutes for this.",
      "**Secondary:** probiotic surface treatment to occupy the surface niches mold would otherwise colonize, plus HEPA to catch airborne spores.",
      "### Pollen and outdoor air (seasonal)",
      "**Primary:** HEPA, running continuously in the bedroom during your season, with windows shut.",
      "**Secondary:** surface treatment for the pollen tracked in on clothes, hair, and pets that settles on furniture.",
      "### Smoke, VOCs, and irritant gases",
      "**Primary:** activated carbon plus HEPA. Particle filtration alone will not touch a gas.",
      ...
      "**Sealed true HEPA**, not \"HEPA-like\" or \"HEPA-type.\" **CADR rated for your room size**, ideally AHAM Verified. **Explicitly no ozone**, stated by the manufacturer. **A carbon stage** if gases or odors are among your triggers. **Quiet operation** at the setting you'll actually run. For probiotic systems, look for FDA GRAS strain classification and third-party safety certification such as MADE SAFE.",
      "## The bottom line",
      "Match the tool to the trigger. HEPA for what's in the air, surface treatment for what's in the mattress and the carpet, carbon for gases, and nothing that makes ozone. Most asthma households with year-round symptoms are dealing with a settled reservoir, which is precisely the part a filter can't reach, and that's the gap probiotic surface treatment was built for.",
      "And the part worth repeating: this is environmental control. It sits alongside your medication and your doctor's plan, never in place of them.",
      "## Frequently asked questions",
      "**Do air purifiers help with asthma?** They can help by reducing the environmental triggers that set off symptoms, but they don't treat asthma itself. Reducing airborne and surface allergens lowers exposure, which is standard environmental-control advice from allergists. An air purifier supplements, and never replaces, your prescribed medication and your doctor's asthma action plan.",
      "**What is the best type of air purifier for asthma?** It depends on your main trigger. For airborne triggers (pollen, dander, smoke), a true HEPA purifier is best. For settled triggers (dust mites, mold), surface control matters more than air filtration, and probiotic surface treatment addresses those reservoirs. Many asthma households do best combining HEPA for the air with surface treatment for bedding, carpet, and upholstery.",
      "**Are ionizers and ozone air purifiers safe for asthma?** No, they are the type to avoid. Ozone is a respiratory irritant that can trigger and worsen asthma, and ionizers can generate ozone as a byproduct. Health authorities specifically warn people with asthma away from ozone-generating air cleaners. Choose devices that are explicitly no-ozone, whether that's a HEPA filter or a biological probiotic system.",
  ...
  },
  {
    ...
    content: [
      ...
      "## Frequently asked questions",
      "**Is the BioLogic Mini Gen 2 safe to use in a baby's nursery?** Yes. It uses **Bacillus** probiotic strains that carry FDA GRAS (Generally Recognized as Safe) classification, MADE SAFE certification, and EPA Registered status. The device contains no ozone, no VOCs, no fragrance, and no chemicals. It's designed for continuous use in rooms occupied by infants and pets.",
  ...
  },
  {
    ...
    content: [
      ...
      "Here's the difference that matters. A room purifier treats the air and surfaces within its coverage radius, 300 sq ft for a small unit, up to 800 for a large one. To cover a whole house that way, you'd need one unit per room, each with its own cartridge and its own plug. The [E-Biotic Pro](/business) covers up to 25,000 sq ft from a single point, because it borrows the reach your furnace and air conditioner already have. Every time the system moves air, it moves probiotics with it.",
      "It's the same technology as the room units, the same family of Bacillus strains, the same competitive exclusion mechanism, the same FDA GRAS, MADE SAFE, and EPA Registered status. What's different is scale and delivery. This is the whole-home tier of the EnviroBiotics line, and it's built for a specific kind of buyer: someone with a larger home, central HVAC, and a problem that isn't confined to one room.",
      ...
      "> Not sure whole-home is right for your space? Start with the [room vs whole-home decision guide](/blog/room-vs-whole-home-probiotic).",
      "## The installation process",
      "This is not a plug-and-play device, and that's the single most important thing to understand before buying. The E-Biotic Pro integrates with your HVAC and is installed by a technician from the [certified installer network](/hvac). Here's what actually happens.",
      ...
      "Ready for whole-home coverage? See the [E-Biotic Pro](/business) and find a certified installer."
    ],
  },
  {
    slug: "envirobiotics-vs-molekule",
    title: "EnviroBiotics vs Molekule: Premium Air Purifier Comparison (2026)",
    description: "Molekule destroys airborne molecules with PECO; EnviroBiotics colonizes surfaces with probiotics. Here's how the two premium approaches actually compare.",
    image: probioticVsHepaImg,
    category: "blog",
    tags: ["comparison", "molekule", "air-purifier", "probiotic", "surface-treatment", "premium"],
    relatedSlugs: ["probiotic-vs-hepa-air-purifier", "what-is-probiotic-air-purifier", "why-air-purifiers-dont-solve-allergies", "how-to-reduce-indoor-allergens-naturally"],
    content: [
      ...
      "EnviroBiotics starts from the same place and takes it one step further. Yes, capture isn't enough, and neither is airborne destruction, because most of the problem was never in the air to begin with. So this isn't an attack piece. It's a comparison between two brands that agree on the diagnosis and diverge on the treatment. See the [probiotic vs HEPA comparison](/blog/probiotic-vs-hepa-air-purifier) for the broader technology context. Let's look at each mechanism honestly, then figure out which fits which problem.",
      ...
      "> Want the surface half of the equation? See how the [BA-2080](/product/ba-2080) works.",
      "## Head to head",
      ...
      "The same guidance applies to running EnviroBiotics alongside any active air-mover, including HEPA units. If you're combining with other in-line technologies, the placement logic in the [probiotic vs HEPA comparison](/blog/probiotic-vs-hepa-air-purifier) covers the same ground.",
      "## The honest verdict",
      ...
      "If it's persistent and surface-based, allergies, mold, dander, musty smell, EnviroBiotics is the only one of the two that reaches the reservoir, and it's backed by published surface-level clinical data plus FDA GRAS, MADE SAFE, and EPA Registered status.",
      ...
      "Ready to cover the surface half? See the [BA-2080](/product/ba-2080) and the full [probiotic vs HEPA comparison](/blog/probiotic-vs-hepa-air-purifier)."
    ],
  },
  {
    slug: "envirobiotics-vs-blueair",
    title: "EnviroBiotics vs Blueair: Premium HEPA vs Probiotic Surface Coverage (2026)",
    description: "Blueair is a premium HEPA leader for airborne particles. EnviroBiotics covers the 80% of allergens and microbes that live on surfaces. Here's how the two actually compare.",
    image: probioticVsHepaImg,
    category: "blog",
    tags: ["comparison", "blueair", "air-purifier", "probiotic", "surface-treatment", "premium", "hepa"],
    relatedSlugs: ["envirobiotics-vs-molekule", "probiotic-vs-hepa-air-purifier", "why-air-purifiers-dont-solve-allergies", "how-to-reduce-indoor-allergens-naturally"],
    content: [
      ...
      "> Want the surface half of the equation? See how the [Biotica 800](https://shop.envirobiotics.com/products/biotica-800) works.",
      "## Head to head",
      ...
      "## Related reading",
      "- [Why air purifiers don't solve allergies, and what actually does](/blog/why-air-purifiers-dont-solve-allergies)",
      "- [Probiotic vs HEPA air purifier: which actually protects your home?](/blog/probiotic-vs-hepa-air-purifier)",
      "- [EnviroBiotics vs Molekule: premium air purifier comparison](/blog/envirobiotics-vs-molekule)",
      "Ready to cover the surface half? See the [Biotica 800](https://shop.envirobiotics.com/products/biotica-800) and the full [probiotic vs HEPA comparison](/blog/probiotic-vs-hepa-air-purifier)."
    ],
  },
  {
    slug: "competitive-exclusion-explained",
    title: "Competitive Exclusion Explained: How Beneficial Bacteria Crowd Out Pathogens",
    description: "Competitive exclusion is how beneficial bacteria crowd out harmful microbes, no antibiotics, no resistance. Here's the plain-English science behind it.",
    image: indoorMicrobiomeHealthImg,
    category: "blog",
    tags: ["competitive-exclusion", "microbiology", "science", "bacillus", "probiotics", "authority"],
    relatedSlugs: ["indoor-microbiome-health", "do-probiotic-air-purifiers-work", "amr-antimicrobial-resistance", "are-environmental-probiotics-safe"],
    content: [
      ...
      "> See the studies behind this in the [research library](/research).",
      "## How beneficial Bacillus bacteria do this on indoor surfaces",
      "Environmental probiotics apply competitive exclusion to the surfaces of your home. The workhorse is the Bacillus genus, hardy, harmless, spore-forming bacteria that occur naturally in soil, plants, and the human gut. (The specifics of which strains and why they're safe are covered in [are environmental probiotics safe](/blog/are-environmental-probiotics-safe).)",
      ...
      "When you kill microbes with an antibiotic or a disinfectant, you apply a selective pressure. The chemical kills most of the population, but any individual that happens to survive (through a resistance mutation, a protective biofilm, a lucky quirk of physiology) now has the whole cleared surface to itself and reproduces freely. Repeat that cycle enough times and you've selected for a resistant population. This is the engine behind [antimicrobial resistance and the indoor environment](/blog/amr-antimicrobial-resistance), and it's why aggressive disinfection can, paradoxically, leave you with tougher pathogens than you started with.",
      ...
      "## Related reading",
      "- [What is indoor microbiome health?](/blog/indoor-microbiome-health)",
      "- [Do probiotic air purifiers work? The science explained](/blog/do-probiotic-air-purifiers-work)",
      "- [Antimicrobial resistance and the indoor environment](/blog/amr-antimicrobial-resistance)",
      "- [Glossary of terms](/glossary)",
      "Want to see competitive exclusion working in a home? Read how [probiotic air purifiers perform](/blog/do-probiotic-air-purifiers-work)."
    ],
  },
  {
    slug: "bacillus-bacteria-indoor-air",
    title: "Bacillus Bacteria for Indoor Air: A Plain-English Look at the Research",
    description: "The Bacillus strains in environmental probiotics are FDA GRAS, occur naturally in soil and the gut, and outcompete pathogens. Here's the plain-English science.",
    image: areProbioticsSafeImg,
    category: "blog",
    tags: ["bacillus", "microbiology", "safety", "gras", "science", "authority", "probiotics"],
    relatedSlugs: ["competitive-exclusion-explained", "do-probiotic-air-purifiers-work", "are-environmental-probiotics-safe", "indoor-microbiome-health"],
    content: [
      ...
      "To be honest about the boundaries: GRAS is about safety, not efficacy, it says the organism won't hurt you, not that it does a particular job. The efficacy evidence is separate (and covered below and in the clinical data). But on the question most people actually worry about, 'is this safe to have around my kids and pets?', GRAS is the substantive answer, and it's backed by MADE SAFE certification and EPA Registered status as well. The [environmental probiotic safety profile](/blog/are-environmental-probiotics-safe) lays out all three in detail.",
      "> Read the full safety profile, certifications and all. → [Are environmental probiotics safe?](/blog/are-environmental-probiotics-safe)",
      ...
      "- **Competitive exclusion.** By occupying the surface and consuming the food, Bacillus leaves harmful microbes with nowhere to attach and nothing to eat. They're crowded out and starved rather than killed. This is [competitive exclusion](/blog/competitive-exclusion-explained), the core mechanism, and the reason the approach creates no drug resistance the way chemical disinfection does.",
      ...
      "The net effect is a surface that stays occupied by harmless organisms, and therefore resistant to the harmful ones. This is what people mean when they ask [do probiotic air purifiers work](/blog/do-probiotic-air-purifiers-work): the 'work' is this surface-level microbial competition, not filtering particles from the air.",
      "## What the research actually shows",
      ...
      "## Related reading",
      "- [Competitive exclusion explained: how beneficial bacteria crowd out pathogens](/blog/competitive-exclusion-explained)",
      "- [Do probiotic air purifiers work? The science explained](/blog/do-probiotic-air-purifiers-work)",
      "- [Are environmental probiotics safe? Safety data and certifications](/blog/are-environmental-probiotics-safe)",
      "- [What is indoor microbiome health?](/blog/indoor-microbiome-health)",
      "Want the home-scale version? The [BioLogic Mini Gen 2](https://shop.envirobiotics.com/products/biologic-mini) is the entry point."
    ],
  },
];
