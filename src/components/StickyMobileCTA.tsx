...
export const StickyMobileCTA = () => {
  ...
  if (["/auth", "/account", "/admin", "/payment-success", "/order-history", "/manage-subscription", "/parents", "/pets", "/allergy", "/wellness", "/spa-wellness"].some(p => location.pathname.startsWith(p))) return null;
