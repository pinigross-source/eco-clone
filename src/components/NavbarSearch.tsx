...
const contentPages = [
  ...
  { title: "Health Benefits", description: "Probiotic air purification health benefits", href: "/benefits", category: "page" as const, keywords: ["allergy", "asthma", "respiratory", "immune", "wellness", "breathing", "comfort", "sensitivity", "dust", "mold"] },
  ...
  { title: "Product Registration", description: "Register your EnviroBiotics product", href: "/register", category: "page" as const, keywords: ["register", "serial number", "activate", "warranty registration"] },
