      ...
      <div className="relative py-20 sm:py-24 lg:py-28">
        <div className="container">
          <ScrollReveal variant="fadeUp">
            <div className="max-w-2xl mr-auto ml-0 rounded-[1.5rem] bg-background/95 backdrop-blur-xl ring-1 ring-foreground/10 shadow-2xl p-9 sm:p-12 lg:p-14 text-left">
