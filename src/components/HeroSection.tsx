      ...
      <div className="container relative z-10 pb-12 pt-24 sm:pb-20 sm:pt-32 lg:pb-24">
        <div className="grid gap-10 lg:grid-cols-12 lg:items-end lg:gap-8">
          <div className="lg:col-span-7 text-left">
            ...
            >
              Air purifiers move air. Sprays mask odors. Our device releases living probiotics that break down the source on every high-touch surface a filter never reaches.<br />24 hours a day, every day.
            </p>
